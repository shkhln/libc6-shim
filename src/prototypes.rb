...
lsb_define([], [
  ...
  "int ftw64(const char* path, int (*fn)(const char*, const struct stat64*, int), int maxfds)",
  ...
  "int nftw64(const char* path, int (*fn)(const char*, const struct stat64*, int, struct FTW*), int maxfds, int flags)",
